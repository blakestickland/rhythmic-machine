...
const defaults = {
    ...
    '__color_highlight'    : '#f542ef',
    '__color_header'       : '#8034eb',
    '__base_font_size'     : 12,
...
const setStyles = (totalSteps) => {
    ...
    setProperty('--color-header', defaults.__color_header)
    ...
    setProperty('--left-gutter-size', defaults.__track_title_width + defaults.__grid_unit * 5 * 2 -20 + 'px')
